                ...
                filteredTramites.map((tramite) => {
                  ...
                  return (
                    <tr key={tramite.id} className="hover:bg-slate-50/50 transition">
                      ...
                      <td className="py-4 px-6">
                        <span className="font-mono font-bold bg-slate-50 border px-2 py-1 rounded text-slate-700 whitespace-nowrap inline-block">
                          {tramite.pdi.docType}: {formatDocument(tramite.pdi.docType, tramite.pdi.docNumber)}
                        </span>
                      </td>
                ...
                <div className="space-y-1.5 text-xs flex-grow font-medium text-slate-700">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-0.5">
                    ...
                    <div>
                      ...
                      <span className="font-mono font-bold text-slate-800 whitespace-nowrap inline-block">{formatDocument(selectedTramiteForValidation.pdi.docType, selectedTramiteForValidation.pdi.docNumber)}</span>
                    </div>
                  </div>
            ...
            <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-xl border border-slate-150 text-xs font-medium">
                ...
                <div>
                  ...
                  <span className="font-mono font-bold text-slate-800 whitespace-nowrap inline-block">{selectedTramiteForDetails.pdi.docType} {formatDocument(selectedTramiteForDetails.pdi.docType, selectedTramiteForDetails.pdi.docNumber)}</span>
                </div>
                <div>
              ...
              <div className="border border-slate-200 rounded-xl p-4 space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs font-medium text-slate-600">
                  ...
                  <p><strong className="text-slate-700">Documentación:</strong> <span className="whitespace-nowrap inline-block font-mono font-medium text-slate-800">{selectedTramiteForDetails.pdi.docType} {formatDocument(selectedTramiteForDetails.pdi.docType, selectedTramiteForDetails.pdi.docNumber)}</span></p>
                </div>
              </div>
